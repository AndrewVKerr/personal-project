...
import net.projectio.server.protocols.AsymmetricalPacket;
import net.projectio.utils.exceptions.LockedValueException;
...
public class HttpPacket extends AsymmetricalPacket{
	...
	public void Method(Methods value) throws LockedValueException {
		if(this.isLocked())
			throw new LockedValueException("HttpPacket.Method(String)");
		this.Method = value;
	}
	...
	public void Url(String value) throws LockedValueException {
		if(this.isLocked())
			throw new LockedValueException("HttpPacket.Url(String)");
		this.Url = value;
	}
	...
	public void Version(String value) throws LockedValueException {
		if(this.isLocked())
			throw new LockedValueException("HttpPacket.Version(String)");
		this.Version = value;
	}
	...
	public void StatusCode(int code) throws LockedValueException {
		if(this.isLocked())
			throw new LockedValueException("HttpPacket.StatusCode(Integer)");
	...
	public void StatusText(String text) throws LockedValueException {
		if(this.isLocked())
			throw new LockedValueException("HttpPacket.StatusText(String)");
	...
	public void Payload(byte[] value) throws LockedValueException {
		if(this.isLocked())
			throw new LockedValueException("HttpPacket.Payload(String)");
		this.Payload = value;
	}
	...
	public void setHeaderValue(String key, String value) throws LockedValueException {
		if(this.isLocked())
			throw new LockedValueException("HttpPacket.setHeaderValue(String,String)");
